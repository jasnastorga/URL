...
class Form extends React.Component {
    ...
    onSubmit = async (event) => {
        ...
        var generatedURL = "smallink.com/" + generatedKey

        if (this.state.preferedAlias !== '') {
            generatedKey = this.state.preferedAlias
            generatedURL = "smallink.com/" + this.state.preferedAlias
        }
        ...
        return (
            <div className="container">
                <form autoComplete="off">
                    ...
                    <div className="form-group">
                        <label htmlFor="basic-url">Small URL</label>
                        <div className="input-group mb-3">
                            <div className="input-group-prepend">
                                <span className="input-group-text">smallink.com/</span>
                            </div>
                            <input
                                id="preferedAlias"
                                onChange={this.handleChange}
